...
class SnapPointBase :
    public ReferenceTracker<SnapPointBase, winrt::Islands::UI::Xaml::Controls::Primitives::implementation::SnapPointBaseT, winrt::composable, winrt::composing>
{
public:
...
protected:
    ...
    double m_specifiedApplicableRange{ std::numeric_limits<double>::infinity() };
#ifdef ApplicableRangeType
...
class ScrollSnapPointBase :
    public winrt::Islands::UI::Xaml::Controls::Primitives::implementation::ScrollSnapPointBaseT<ScrollSnapPointBase, SnapPointBase>
{
public:
...
class ScrollSnapPoint:
    public winrt::Islands::UI::Xaml::Controls::Primitives::implementation::ScrollSnapPointT<ScrollSnapPoint, ScrollSnapPointBase>
{
public:
    ScrollSnapPoint(
...
class RepeatedScrollSnapPoint :
    public winrt::Islands::UI::Xaml::Controls::Primitives::implementation::RepeatedScrollSnapPointT<RepeatedScrollSnapPoint, ScrollSnapPointBase>
{
public:
...
class ZoomSnapPointBase :
    public winrt::Islands::UI::Xaml::Controls::Primitives::implementation::ZoomSnapPointBaseT<ZoomSnapPointBase, SnapPointBase>
{
    bool OnUpdateViewport(double newViewport);
...
class ZoomSnapPoint :
    public winrt::Islands::UI::Xaml::Controls::Primitives::implementation::ZoomSnapPointT<ZoomSnapPoint, ZoomSnapPointBase>
{
public:
    ZoomSnapPoint(
        double snapPointValue);
...
class RepeatedZoomSnapPoint :
    public winrt::Islands::UI::Xaml::Controls::Primitives::implementation::RepeatedZoomSnapPointT<RepeatedZoomSnapPoint, ZoomSnapPointBase>
{
public:
...
namespace winrt::Islands::UI::Xaml::Controls::Primitives::implementation { using SnapPointBase = ::SnapPointBase; }
namespace winrt::Islands::UI::Xaml::Controls::Primitives::implementation { using ScrollSnapPointBase = ::ScrollSnapPointBase; }
namespace winrt::Islands::UI::Xaml::Controls::Primitives::implementation { using ScrollSnapPoint = ::ScrollSnapPoint; }
namespace winrt::Islands::UI::Xaml::Controls::Primitives::implementation { using RepeatedScrollSnapPoint = ::RepeatedScrollSnapPoint; }
namespace winrt::Islands::UI::Xaml::Controls::Primitives::implementation { using ZoomSnapPointBase = ::ZoomSnapPointBase; }
namespace winrt::Islands::UI::Xaml::Controls::Primitives::implementation { using ZoomSnapPoint = ::ZoomSnapPoint; }
namespace winrt::Islands::UI::Xaml::Controls::Primitives::implementation { using RepeatedZoomSnapPoint = ::RepeatedZoomSnapPoint; }
}
