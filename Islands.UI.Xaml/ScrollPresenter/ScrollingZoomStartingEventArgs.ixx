...
export module ixx.ScrollingZoomStartingEventArgs;
...
namespace winrt::Islands::UI::Xaml::Controls::implementation { using ScrollingZoomStartingEventArgs = ::ScrollingZoomStartingEventArgs; }
}
