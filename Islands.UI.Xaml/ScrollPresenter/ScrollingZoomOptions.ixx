...
export module ixx.ScrollingZoomOptions;
...
class ScrollingZoomOptions :
    public winrt::Islands::UI::Xaml::Controls::implementation::ScrollingZoomOptionsT<ScrollingZoomOptions>
{
public:
...
namespace winrt::Islands::UI::Xaml::Controls::implementation { using ScrollingZoomOptions = ::ScrollingZoomOptions; }
}
