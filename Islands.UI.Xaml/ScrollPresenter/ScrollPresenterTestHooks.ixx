...
export module ixx.ScrollPresenterTestHooks;
...
class ScrollPresenterTestHooks :
    public winrt::Islands::UI::Xaml::Controls::Primitives::implementation::ScrollPresenterTestHooksT<ScrollPresenterTestHooks>
{
public:
...
namespace winrt::Islands::UI::Xaml::Controls::Primitives::implementation { using ScrollPresenterTestHooks = ::ScrollPresenterTestHooks; }
}
