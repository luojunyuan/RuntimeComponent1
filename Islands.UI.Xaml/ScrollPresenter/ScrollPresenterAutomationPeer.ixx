...
export module ixx.ScrollPresenterAutomationPeer;
...
class ScrollPresenterAutomationPeer :
    public ReferenceTracker<ScrollPresenterAutomationPeer, winrt::Islands::UI::Xaml::Automation::Peers::implementation::ScrollPresenterAutomationPeerT, winrt::IScrollProvider>
{
public:
...
namespace winrt::Islands::UI::Xaml::Automation::Peers::implementation { using ScrollPresenterAutomationPeer = ::ScrollPresenterAutomationPeer; }
}
