...
export module ixx.ScrollView;

import inc.common;
import inc.tracker_ref;
import ixx.ScrollBarController;
import ixx.ScrollView.properties;
...
private:
    ...
    static std::shared_ptr<AutoHideScrollBarsState> MakeAutoHideScrollBarsState();
    std::shared_ptr<AutoHideScrollBarsState> m_autoHideScrollBarsState = MakeAutoHideScrollBarsState();
...
namespace winrt::Islands::UI::Xaml::Controls::implementation { using ScrollView = ::ScrollView; }
}
