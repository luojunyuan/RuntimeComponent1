...
export module ixx.ScrollViewTrace;
...
inline bool IsScrollViewTracingEnabled()
{
    return g_IsLoggingProviderEnabled &&
        ...
        (g_LoggingProviderMatchAnyKeyword & KeywordScrollView || g_LoggingProviderMatchAnyKeyword == 0);
}
...
inline bool IsScrollViewPerfTracingEnabled()
{
    return g_IsPerfProviderEnabled &&
        ...
        (g_PerfProviderMatchAnyKeyword & KeywordScrollView || g_PerfProviderMatchAnyKeyword == 0);
}
        ...
        if (SUCCEEDED(StringCchVPrintfW(buffer, ARRAYSIZE(buffer), message, args)))
        {
            if (includeTraceLogging)
            {
                ...
                TraceLoggingWrite(
                    ...
                    TraceLoggingKeyword(KeywordScrollView),
