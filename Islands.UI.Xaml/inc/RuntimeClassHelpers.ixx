...
export module inc.RuntimeClassHelpers;
...
{
    using FinalReleaseCallback = void(*)(void*) noexcept;
...
struct ReferenceTracker : public ImplT<D, I ..., IReferenceTrackerExtension>, public ITrackerHandleManager
{
    ...
    static void DeleteInstanceOnUIThread(std::unique_ptr<D>&& self) noexcept
    {
        ...
        if(!self->IsOnThread())
        {
            ...
            {
                auto instance = self.release();
                queued = RuntimeClassHelpersDetail::TryEnqueueFinalRelease(
                    dispatcherQueue,
                    instance,
                    [](void* value) noexcept
                    {
                        delete static_cast<D*>(value);
                    });
