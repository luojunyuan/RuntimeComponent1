...
export module inc.CppWinRTHelpers;
...
template <typename D, typename T, typename ... I>
struct __declspec(empty_bases)DeriveFromBitmapIconSourceHelper_base : winrt::Windows::UI::Xaml::Controls::BitmapIconSourceT<D, winrt::default_interface<T>, winrt::composable, I...>
{
    using composable = T;
    using class_type = typename T;
...
template <typename D, typename T, typename ... I>
struct __declspec(empty_bases)DeriveFromPathIconSourceHelper_base : winrt::Windows::UI::Xaml::Controls::PathIconSourceT<D, winrt::default_interface<T>, winrt::composable, I...>
{
    using composable = T;
    using class_type = typename T;
...
template <typename D, typename T, typename ... I>
struct __declspec(empty_bases) DeriveFromRangeBaseHelper_base : winrt::Windows::UI::Xaml::Controls::Primitives::RangeBaseT<D, winrt::default_interface<T>, winrt::composable, I...>
{
    using composable = T;
    using class_type = typename T;
...
struct Awaitable
{
    Awaitable()
    {
        m_signal.attach(createEvent(nullptr, win32True, win32False, nullptr));
    }
